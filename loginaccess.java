...
public class loginaccess extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Central-CE Laboratoty WareHouse Management System - 2018 All right received.");
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/col.png"))); // NOI18N
        jButton2.setToolTipText("Log In As User");
        ...
        jButton1.setToolTipText("Log In As an Admin");
        ...
        jLabel3.setText("Central-CE (pvt)Ltd.Kandy. ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     exdate.set(2022,11,30); //31 days back
     
     if(Calendar.getInstance().after(exdate))
     {
     JOptionPane.showMessageDialog(rootPane,"Sorry your product was Expired.");
     System.exit(0);
     }
     else
     {
